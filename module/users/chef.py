...
class Chef(UserInterface):
    ...
    def add_menu_item(self):
        try:
            ...
            is_deleted = input(
                f"{Fore.YELLOW}Enter 1 for deleted or 0 for not deleted : {Style.RESET_ALL}"
            )
            dietary_preference = input(
                f"{Fore.YELLOW}Enter the dietary_preference: (enter Vegeterian, Non Vegeterian): {Style.RESET_ALL}"
            )
            spice_level = input(
                f"{Fore.YELLOW}Enter the spice_level: (enter High, Low, Medium): {Style.RESET_ALL}"
            )
            ...
            sweet_tooth = input(
                f"{Fore.YELLOW}Enter the sweet_tooth: (enter Yes or No): {Style.RESET_ALL}"
            )
    ...
    def update_menu_item(self):
        try:
            menu_id = int(
                input(
                    f"{Fore.YELLOW}Enter the menu ID of the item you want to update: {Style.RESET_ALL}"
                )
            )
            ...
            price = input(
                f"{Fore.YELLOW}Enter new price (leave blank if no change): {Style.RESET_ALL}"
            ).strip()
            ...
            if kwargs:
                ...
                print(
                    f"{Fore.YELLOW}No valid inputs provided. No updates made.{Style.RESET_ALL}"
                )
        except Exception as e:
            print(
                f"{Fore.RED}An error occurred while updating a menu item: {e}{Style.RESET_ALL}"
            )
    ...
    def view_menu(self):
        try:
            ...
            print(
                f"{Fore.RED}An error occurred while viewing the menu: {e}{Style.RESET_ALL}"
            )
    ...
    def add_final_recommendation(self):
        try:
            num_of_recommendation = int(
                input(
                    "Enter the number of recommendation you want to recommend for tommorow : "
                )
            )
            for iterator in range(num_of_recommendation):
                menu_id = int(
                    input(Fore.CYAN + "Enter the menuID to recommend for tomorrow: ")
                )
                response = self.client.send_message(
