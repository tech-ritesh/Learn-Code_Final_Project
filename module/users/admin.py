...
from utils.admin_utils import DiscardMenuItemManager, UserInteraction
    ...
    def main_menu(self):
        try:
            while True:
                ...
                actions = {
                    1: self.add_menu_item,
                    2: self.update_menu_item,
                    3: self.delete_menu_item,
                    4: self.view_menu,
                    5: self.discard_menu_items,
                    6: self.exit_program
                }
