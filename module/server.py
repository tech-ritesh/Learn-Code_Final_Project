    ...
    def process_request(self, message):
        try:
            ...
            if action == "authenticate":
                ...
                discard_menu_items = discard_menu_item_list.discard_list()
                delete_discarded.delete_discarded_menuItem()
                ...
                EmployeeID, DietaryPreference, SpiceLevel, PreferredCuisine, SweetTooth = int(parts[1]), parts[2], parts[3], parts[4], parts[5]
                print(int(parts[1]), parts[2], parts[3], parts[4], parts[5])
                update_profile.update_profile(EmployeeID, DietaryPreference, SpiceLevel, PreferredCuisine, SweetTooth)
